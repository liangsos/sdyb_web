    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.code == 1) {
                ...
                //最大降水量站
                $("#yq_zdjslz_name").html(res.station.xian + res.station.stnm);
                $("#yq_zdjslz_value").html(res.station.rain);

                //两个特别地区
                $("#sx_1_name").html(res.shuixi[0].name);
                $("#sx_1_value").html(res.shuixi[0].rain);
                $("#sx_2_name").html(res.shuixi[1].name);
                $("#sx_2_value").html(res.shuixi[1].rain);
                if (!isfirst) {
                    sengMsgToEarth({
                        data: earth_info,
                        des: "添加雨量信息",
