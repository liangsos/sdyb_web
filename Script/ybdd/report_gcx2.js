...
function setGXCReportSize(reportId, width, height) {
    ...
    var margin_right = 0;
    var bjTable_height = $("#bjTable").height();
    if (bjTable_height >= 131) {
        bjTable_height = 131;
    }
 ...
 * 显示窗口
 */
function show_report_gcx(_stcd, _stime, _etime, _userId, _stnm, _sttp,_day) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (json.code == "0") {
                ...
                getBjTableData(_stcd, _stime, _etime, _userId, _day);
                $("#panel_BJ_Gcx").show();
